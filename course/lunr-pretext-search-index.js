...
var ptx_lunr_docs = [
{
  ...
  "number": "",
  "title": "Syllabus",
  "body": " Syllabus   Welcome to Molecular Biology! We will spend this semester learning how biology works at the molecular level, with large focus on how molecular machines work.     Course Information  This is the syllabus for BIOL 262 Molecular Biology for Fall 2026.   Instructor  Dr. Rachel Avard, Hemenway Annex 614, ravard@framingham.edu .    Student Hours  TBD   Walk ins are welcome! Students who make appointments will have priority, but if I am in my office and I’m not meeting with anyone else, please feel free to stop by with any questions you have. I am here to help!  In most situations, students are limited to 30 minutes of office hours a week. This is to ensure that all students have fair access to office hours, as well as to ensure that each student has the opportunity to work through material independently. This rule can be broken in appropriate \/ extenuating situations, please speak with me if the need arises!    Class meets  course times and location.    Course Description  An examination of the way the cell accesses, uses, and maintains the information stored in the genome. It begins with an overview of DNA structure and topology, continues with replication, transcription, and translation, and concludes with gene regulation. Special topics could include cancer, stem cells, and RNAi, and focusing on the structure-function relationships of the molecules involved in these processes. Students are required to enroll in the corresponding laboratory (3 hours).    Prerequisite  BIOL 135 Foundations of Biological Science with Lab, and CHEM 108 Principles of Chemistry and Quantitative Analysis with Lab; or permission of the instructor    Textbook and course materials   textbook name by textbook author.      Course Overview       Assessments and Grades     Learning targets  By the end of this course, you should be able to:              Assessment of Learning Targets      Final Exam      Assessment of Mathematical Engagement  Your level of effort and engagement will be assessed through your participation in class and completion of a variety of homework assignments.   Participation      Daily Prep Assignments      Practice Problems      Written Homework         Final Grades        Course Policies   Attendance      Late work      Classroom Decorum      Academic Integrity      Generative AI      Title IX and Equal Opportunity       Important Dates     Friday, Aug 25  Last day to add a class    Monday, Sep 4  Labor Day (no classes)    Monday, Sep 8  Last day to drop a class    Nov 26 - Nov 28  Thanksgiving break (no classes Wednesday, Thursday or Friday)    Friday, Dec 5  Last day to withdraw from class and receive a W    Thursday, Dec 11  Final Exam from 10:45am to 1:15pm      "
},
{
  ...
  "number": "",
  "title": "",
  "body": "BIOL 262 Molecular Biology "
},
{
  "id": "notes-week-01",
  "level": "1",
